...
export default function Contact() {
  ...
  return (
    <div className="contact">
      ...
      <p>
        Our classes run Monday - Saturday and are 45 minutes long. In each class
        we focus on specific areas of the body to achieve strength, flexibility
        and balance. The cost is £10 per session or £30 for a monthly
        membership. Your first 2 taster Yoga classes will be{" "}
        ...
        each class. All you need is your Yoga mat, a bottle of water, a cushion
        or towel for support and your smile!
        <br />
        <br />
